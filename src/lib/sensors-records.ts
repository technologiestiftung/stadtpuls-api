...
const sensorSelection =
  "id, external_id, name, description, connection_type, location, longitude, latitude, altitude, category_id, icon_id, created_at, category:categories (name, description), author:user_profiles(name, display_name)";
